...
void initialize_transition_table()
{
    ...
    for (char c = '0'; c <= '9'; c++)
    {
        transition_table[7][(int)c] = 9;
    }

    for (char c = '0'; c <= '9'; c++)
    {
        transition_table[8][(int)c] = 9;
    }

    for (char c = '0'; c <= '9'; c++)
    {
        transition_table[9][(int)c] = 9;
    }
    transition_table[9]['\n'] = 3;
}
